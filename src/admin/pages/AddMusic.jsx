...
function AddMusic() {
  ...
  const handleFileChange = (e) => {
    ...
    if (fileSizeInMB > 500) {
      showToast.warning(
        `Large file detected (${sizeFormatted}). Upload may take several minutes. Please be patient.`,
      );
    }
  ...
  formData.append("description", description.trim());
    ...
    try {
      ...
      if (
        ...
        errorMessage =
          "File is too large. Server cannot process files of this size.";
            ...
            >
              <div
                style={{
                  ...
                  backgroundColor:
                    uploadProgress === 100 ? "#4CAF50" : "#2196F3",
                  height: "100%",
